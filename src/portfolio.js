...
const socialMediaLinks = {
  github: "https://github.com/vinniedaboi",
  gmail: "vinnie5224@gmail.com",
...
const educationInfo = {
  ...
  schools: [
    {
      schoolName: "High School somewhere in Asia",
...
const workExperiences = {
  ...
  experience: [
    {
      role: "Software Engineer, Pentesting",
      company: "Exsim",
      companylogo: require("./assets/images/exsimlogo.png"),
      date: "2021-2023",
...
const blogSection = {
  title: "Blogs and Researchs",
  subtitle:
    "Some of my research papers and blogs",
  displayMediumBlogs: "false", // Set true to display fetched medium blogs instead of hardcoded ones
  blogs: [
    {
      url: "https://medium.com/@kidosol5224/making-your-first-cinematic-in-ue5-916241b77a87",
      title: "Making your first UE5 cinematic",
      description:
